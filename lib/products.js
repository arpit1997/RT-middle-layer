...
var convert_helper = function (data, callback) {
      ...
      'variants': [
        {
          ...
          'images':[
            IMAGE_BASE_URL + small_image,
            IMAGE_BASE_URL + big_image
          ],
          'code':"abcd"
        }
      ]
  ...
  var converted_data_formatted = {
    'metadata':{
      'links': {
        "first": "https://middle-layer.gomix.me/v1.2/21/products?limit=10&offset=8",
        "last": "https://middle-layer.gomix.me/v1.2/21/products?limit=10&offset=8",
        "prev": "https://middle-layer.gomix.me/v1.2/21/products?limit=10&offset=8",
        "next": "https://middle-layer.gomix.me/v1.2/21/products?limit=10&offset=8",
        "self": "https://middle-layer.gomix.me/v1.2/21/products?limit=10&offset=8"
      },
      'sorting': "newest",
      'records_count': 676
    },
