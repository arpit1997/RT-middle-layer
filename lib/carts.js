...
exports.cart_info_items = function (cart_details, cart_items, cart_items_mini, callback) {
  ...
  for (var i in cart_items.records){
    ...
    item.url = cart_items.records[i].url
    item.name = cart_items.records[i].name
    item.price = cart_items.records[i].price
    item.price_formatted = cart_items.records[i].price_formatted
    item.category = cart_items.records[i].category
    item.discount_price = cart_items.records[i].discount_price
    item.discount_prie_formatted = cart_items.records[i].discount_price_formatted
    item.currency = cart_items.records[i].currency
    item.code = cart_items.records[i].code
    item.description = cart_items.records[i].description
    item.main_image = cart_items.records[i].main_image
