...
exports.shipping_info = function(token, cart_info, callback){
  var total_price = cart_info.total_price
  var response = {
    "delivery": {
		"personal_pickup": [{
			"id": 332,
			...
			"total_price": 10238,
			"total_price_formatted": "$10,238.00",
			"currency": "USD",
			"min_cart_amount": 50,
			"payment": [{
				"id": 67,
				...
				"total_price": 10239,
				"total_price_formatted": "$10,239.00",
				"currency": "USD"
			}],
